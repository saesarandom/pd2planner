...
const affixDatabase = {
  prefixes: {
    ...
    'Crimson2': { stats: { firres: { min: 5, max: 10 } }, itemTypes: ['Armor', 'Weapon', 'Ring', 'Amulet', 'Circlet', 'Quiver'], reqLvl: 3, group: 118 },
    ...
    'Glowing2': { stats: { lightning: { min: 1, max: 180 } }, itemTypes: ['Weapon', 'Quiver'], reqLvl: 25, group: 139 },
  ...
  suffixes: {
    ...
    'Protection2': { stats: { pdmgred: { min: 2, max: 2 } }, itemTypes: ['Ring', 'Amulet', 'Circlet', 'Quiver'], reqLvl: 13, group: 1 },
    'Protection3': { stats: { pdmgred: { min: 2, max: 2 } }, itemTypes: ['Chest', 'Shield', 'Circlet'], reqLvl: 18, group: 1 },
    'Absorption': { stats: { pdmgred: { min: 3, max: 3 } }, itemTypes: ['Amulet', 'Circlet', 'Quiver'], reqLvl: 19, group: 1 },
    'Absorption2': { stats: { pdmgred: { min: 3, max: 3 } }, itemTypes: ['Chest', 'Shield', 'Circlet', 'Ring'], reqLvl: 24, group: 1 },
    'Life': { stats: { pdmgred: { min: 4, max: 4 } }, itemTypes: ['Amulet', 'Circlet', 'Quiver'], reqLvl: 26, group: 1 },
    'Life2': { stats: { pdmgred: { min: 4, max: 7 } }, itemTypes: ['Chest', 'Shield', 'Circlet', 'Ring'], reqLvl: 33, group: 1 },
    ...
    'Life Everlasting2': { stats: { pdmgred: { min: 10, max: 25 } }, itemTypes: ['Chest', 'Shield'], reqLvl: 37, group: 1 },
    ...
    'Sentinel2': { stats: { mdmgred: { min: 2, max: 4 } }, itemTypes: ['Chest', 'Shield', 'Circlet'], reqLvl: 18, group: 2 },
    'Guarding': { stats: { mdmgred: { min: 3, max: 6 } }, itemTypes: ['Amulet', 'Orb', 'Circlet', 'Quiver'], reqLvl: 19, group: 2 },
    'Guarding2': { stats: { mdmgred: { min: 3, max: 6 } }, itemTypes: ['Chest', 'Shield', 'Circlet', 'Ring'], reqLvl: 24, group: 2 },
    'Negation': { stats: { mdmgred: { min: 8, max: 12 } }, itemTypes: ['Chest', 'Shield', 'Circlet'], reqLvl: 33, group: 2 },
    'Negation2': { stats: { mdmgred: { min: 8, max: 12 } }, itemTypes: ['Amulet', 'Orb', 'Circlet', 'Quiver'], reqLvl: 35, group: 2 },
    'Fortification': { stats: { mdmgred: { min: 12, max: 16 } }, itemTypes: ['Chest', 'Shield'], reqLvl: 53, group: 2 },

    // === GROUP 4: Ignore Target's Defense ===
    'Piercing2': { stats: { itd: { min: 1, max: 1 } }, itemTypes: ['Rod', 'Knife', 'Claw'], reqLvl: 18, group: 4 },

    // === GROUP 6: Attacker Takes Damage (Thorns) ===
    'Thorns': { stats: { thorns: { min: 1, max: 1 } }, itemTypes: ['Chest', 'Belt', 'Shield'], reqLvl: 1, group: 6 },
    'Thorns2': { stats: { thorns: { min: 3, max: 6 } }, itemTypes: ['Chest', 'Shield', 'Belt', 'Circlet'], reqLvl: 10, group: 6 },
    ...
    'Swords2': { stats: { thorns: { min: 200, max: 400 } }, itemTypes: ['Chest', 'Shield', 'Circlet'], reqLvl: 50, group: 6 },
    ...
    'Readiness2': { stats: { ias: { min: 10, max: 10 } }, itemTypes: ['Gloves'], reqLvl: 15, group: 9 },
    'Alacrity2': { stats: { ias: { min: 20, max: 20 } }, itemTypes: ['Gloves'], reqLvl: 35, group: 9 },
    'Apprentice': { stats: { fcr: { min: 10, max: 10 } }, itemTypes: ['Rod', 'Ring', 'Amulet', 'Orb', 'Circlet', 'Club'], reqLvl: 3, group: 9 },
    'Apprentice2': { stats: { fcr: { min: 10, max: 10 } }, itemTypes: ['Chest', 'Shield', 'Paladin Shield'], reqLvl: 20, group: 9 },
    'Apprentice3': { stats: { fcr: { min: 10, max: 10 } }, itemTypes: ['Gloves', 'Belt'], reqLvl: 29, group: 9 },
    'Magus': { stats: { fcr: { min: 20, max: 20 } }, itemTypes: ['Rod', 'Orb', 'Circlet', 'Club'], reqLvl: 21, group: 9 },
    'Magus2': { stats: { fcr: { min: 20, max: 20 } }, itemTypes: ['Chest', 'Shield', 'Paladin Shield'], reqLvl: 29, group: 9 },
    'Archmage': { stats: { fcr: { min: 30, max: 30 } }, itemTypes: ['Rod', 'Orb', 'Club'], reqLvl: 41, group: 9 },
    'Archmage2': { stats: { fcr: { min: 40, max: 40 } }, itemTypes: ['Rod'], reqLvl: 41, group: 9 },

    // === GROUP 10: Cold Damage ===
    'Frost': { stats: { cold: { min: 1, max: 1 } }, itemTypes: ['WeaponP'], reqLvl: 1, group: 10 },
    'Frost2': { stats: { cold: { min: 1, max: 2 } }, itemTypes: ['WeaponPS', 'Quiver'], reqLvl: 3, group: 10 },
    'Frost3': { stats: { cold: { min: 1, max: 6 } }, itemTypes: ['Belt', 'Amulet'], reqLvl: 37, group: 10 },
    ...
    'Flame2': { stats: { fire: { min: 1, max: 5 } }, itemTypes: ['WeaponPS', 'Quiver'], reqLvl: 3, group: 12 },
    'Flame3': { stats: { fire: { min: 1, max: 6 } }, itemTypes: ['Gloves', 'Ring', 'Amulet'], reqLvl: 30, group: 12 },
    ...
    'Shock2': { stats: { lightning: { min: 1, max: 8 } }, itemTypes: ['WeaponPS', 'Quiver'], reqLvl: 3, group: 13 },
    'Shock3': { stats: { lightning: { min: 1, max: 23 } }, itemTypes: ['Boots', 'Ring', 'Amulet'], reqLvl: 37, group: 13 },
    ...
    'Craftsmanship2': { stats: { maxdmg: { min: 1, max: 2 } }, itemTypes: ['Circlet', 'Helm'], reqLvl: 1, group: 14 },
    'Craftsmanship3': { stats: { maxdmg: { min: 2, max: 3 } }, itemTypes: ['Circlet', 'Helm'], reqLvl: 6, group: 14 },
    'Craftsmanship4': { stats: { maxdmg: { min: 4, max: 5 } }, itemTypes: ['Circlet', 'Helm'], reqLvl: 11, group: 14 },
    'Quality': { stats: { maxdmg: { min: 2, max: 2 } }, itemTypes: ['WeaponP'], reqLvl: 3, group: 14 },
    'Quality2': { stats: { maxdmg: { min: 6, max: 7 } }, itemTypes: ['Circlet', 'Helm'], reqLvl: 17, group: 14 },
    'Quality3': { stats: { maxdmg: { min: 7, max: 8 } }, itemTypes: ['Circlet', 'Helm'], reqLvl: 22, group: 14 },
    'Maiming': { stats: { maxdmg: { min: 3, max: 4 } }, itemTypes: ['WeaponP'], reqLvl: 5, group: 14 },
    'Maiming2': { stats: { maxdmg: { min: 3, max: 4 } }, itemTypes: ['Shield', 'Ring', 'Amulet'], reqLvl: 34, group: 14 },
    'Maiming3': { stats: { maxdmg: { min: 9, max: 10 } }, itemTypes: ['Circlet', 'Helm'], reqLvl: 29, group: 14 },
    'Maiming4': { stats: { maxdmg: { min: 11, max: 12 } }, itemTypes: ['Circlet', 'Helm'], reqLvl: 37, group: 14 },
    ...
    'Carnage2': { stats: { maxdmg: { min: 11, max: 14 } }, itemTypes: ['Ring', 'Amulet', 'Circlet', 'Helm'], reqLvl: 58, group: 14 },
    ...
    'Evisceration2': { stats: { maxdmg: { min: 41, max: 63 } }, itemTypes: ['Missile Weapon'], reqLvl: 37, group: 14 },

    // === GROUP 15: Minimum Damage ===
    'Worth': { stats: { mindmg: { min: 1, max: 2 } }, itemTypes: ['WeaponP'], reqLvl: 1, group: 15 },
    'Worth2': { stats: { mindmg: { min: 2, max: 3 } }, itemTypes: ['Ring', 'Amulet', 'Circlet', 'Helm'], reqLvl: 11, group: 15 },
    'Measure': { stats: { mindmg: { min: 3, max: 4 } }, itemTypes: ['WeaponP'], reqLvl: 9, group: 15 },
    'Measure2': { stats: { mindmg: { min: 4, max: 5 } }, itemTypes: ['Ring', 'Amulet', 'Circlet', 'Helm'], reqLvl: 29, group: 15 },
    'Excellence': { stats: { mindmg: { min: 5, max: 8 } }, itemTypes: ['WeaponP'], reqLvl: 18, group: 15 },
    'Excellence2': { stats: { mindmg: { min: 6, max: 9 } }, itemTypes: ['Ring', 'Amulet', 'Circlet', 'Helm'], reqLvl: 51, group: 15 },
    'Performance': { stats: { mindmg: { min: 9, max: 14 } }, itemTypes: ['WeaponP'], reqLvl: 40, group: 15 },
    'Performance2': { stats: { mindmg: { min: 10, max: 13 } }, itemTypes: ['Ring', 'Amulet', 'Circlet', 'Helm'], reqLvl: 63, group: 15 },
    ...
    'Blight2': { stats: { poison: { min: 7, max: 7 } }, itemTypes: ['WeaponP', 'Circlet', 'Quiver'], reqLvl: 3, group: 16 },
    'Blight3': { stats: { poison: { min: 50, max: 50 } }, itemTypes: ['Ring', 'Amulet'], reqLvl: 33, group: 16 },
    ...
    'Dexterity2': { stats: { dex: { min: 1, max: 1 } }, itemTypes: ['Ring'], reqLvl: 1, group: 17 },
    'Dexterity3': { stats: { dex: { min: 1, max: 2 } }, itemTypes: ['Amulet', 'Missile Weapon', 'Circlet', 'Helm'], reqLvl: 1, group: 17 },
    'Dexterity4': { stats: { dex: { min: 1, max: 2 } }, itemTypes: ['Ring', 'Gloves'], reqLvl: 4, group: 17 },
    'Dexterity5': { stats: { dex: { min: 2, max: 3 } }, itemTypes: ['Chest', 'Boots'], reqLvl: 9, group: 17 },
    'Skill': { stats: { dex: { min: 3, max: 5 } }, itemTypes: ['Amulet', 'Missile Weapon', 'Circlet', 'Quiver', 'Helm'], reqLvl: 8, group: 17 },
    'Skill2': { stats: { dex: { min: 3, max: 5 } }, itemTypes: ['Ring', 'Gloves', 'Boots'], reqLvl: 16, group: 17 },
    'Skill3': { stats: { dex: { min: 4, max: 5 } }, itemTypes: ['Chest'], reqLvl: 26, group: 17 },
    'Accuracy': { stats: { dex: { min: 6, max: 9 } }, itemTypes: ['Amulet', 'Missile Weapon', 'Circlet', 'Quiver', 'Helm'], reqLvl: 20, group: 17 },
    'Accuracy2': { stats: { dex: { min: 6, max: 9 } }, itemTypes: ['Ring', 'Gloves'], reqLvl: 31, group: 17 },
    'Accuracy3': { stats: { dex: { min: 6, max: 9 } }, itemTypes: ['Chest', 'Boots'], reqLvl: 38, group: 17 },
    'Precision': { stats: { dex: { min: 10, max: 15 } }, itemTypes: ['Amulet', 'Missile Weapon', 'Circlet', 'Quiver', 'Helm'], reqLvl: 35, group: 17 },
    'Precision2': { stats: { dex: { min: 10, max: 15 } }, itemTypes: ['Ring', 'Gloves'], reqLvl: 48, group: 17 },
    'Precision3': { stats: { dex: { min: 10, max: 15 } }, itemTypes: ['Chest', 'Boots', 'Shield'], reqLvl: 52, group: 17 },
    'Perfection': { stats: { dex: { min: 16, max: 20 } }, itemTypes: ['Amulet', 'Missile Weapon', 'Circlet', 'Chest', 'Shield', 'Helm'], reqLvl: 51, group: 17 },
    'Perfection2': { stats: { dex: { min: 16, max: 20 } }, itemTypes: ['Ring', 'Gloves'], reqLvl: 67, group: 17 },
    ...
    'Regeneration2': { stats: { regen: { min: 6, max: 10 } }, itemTypes: ['Shield', 'Gloves'], reqLvl: 30, group: 19 },
    'Regeneration3': { stats: { regen: { min: 6, max: 10 } }, itemTypes: ['Chest', 'WeaponP', 'Boots'], reqLvl: 52, group: 19 },
    'Regrowth': { stats: { regen: { min: 12, max: 20 } }, itemTypes: ['Scepter', 'Amulet', 'Circlet'], reqLvl: 12, group: 19 },
    'Regrowth2': { stats: { regen: { min: 12, max: 18 } }, itemTypes: ['Belt', 'Ring'], reqLvl: 41, group: 19 },
    ...
    'Fortune2': { stats: { magicfind: { min: 16, max: 25 } }, itemTypes: ['Ring'], reqLvl: 31, group: 22 },
    ...
    'Energy2': { stats: { energy: { min: 1, max: 3 } }, itemTypes: ['Amulet', 'Orb', 'Circlet', 'Wand', 'Staff', 'Helm', 'Chest'], reqLvl: 1, group: 23 },
    'Energy3': { stats: { energy: { min: 1, max: 3 } }, itemTypes: ['Shield'], reqLvl: 1, group: 23 },
    'Energy4': { stats: { energy: { min: 1, max: 3 } }, itemTypes: ['Ring'], reqLvl: 5, group: 23 },
    'Energy5': { stats: { energy: { min: 1, max: 3 } }, itemTypes: ['Helm', 'Scepter'], reqLvl: 3, group: 23 },
    'Mind': { stats: { energy: { min: 4, max: 6 } }, itemTypes: ['Orb', 'Circlet', 'Wand', 'Staff', 'Quiver', 'Helm', 'Chest'], reqLvl: 3, group: 23 },
    'Mind2': { stats: { energy: { min: 4, max: 6 } }, itemTypes: ['Shield'], reqLvl: 3, group: 23 },
    'Mind3': { stats: { energy: { min: 4, max: 6 } }, itemTypes: ['Ring', 'Amulet'], reqLvl: 9, group: 23 },
    'Mind4': { stats: { energy: { min: 4, max: 6 } }, itemTypes: ['Helm', 'Scepter'], reqLvl: 7, group: 23 },
    'Brilliance': { stats: { energy: { min: 7, max: 10 } }, itemTypes: ['Amulet', 'Orb', 'Circlet', 'Wand', 'Staff', 'Quiver', 'Helm'], reqLvl: 9, group: 23 },
    'Brilliance2': { stats: { energy: { min: 7, max: 10 } }, itemTypes: ['Chest', 'Shield'], reqLvl: 9, group: 23 },
    'Brilliance3': { stats: { energy: { min: 7, max: 10 } }, itemTypes: ['Ring'], reqLvl: 16, group: 23 },
    'Brilliance4': { stats: { energy: { min: 7, max: 10 } }, itemTypes: ['Helm', 'Scepter'], reqLvl: 12, group: 23 },
    'Sorcery': { stats: { energy: { min: 11, max: 15 } }, itemTypes: ['Amulet', 'Orb', 'Circlet', 'Wand', 'Staff', 'Quiver', 'Helm'], reqLvl: 16, group: 23 },
    'Sorcery2': { stats: { energy: { min: 11, max: 15 } }, itemTypes: ['Chest', 'Shield'], reqLvl: 16, group: 23 },
    'Sorcery3': { stats: { energy: { min: 11, max: 15 } }, itemTypes: ['Ring'], reqLvl: 23, group: 23 },
    'Sorcery4': { stats: { energy: { min: 11, max: 15 } }, itemTypes: ['Helm', 'Scepter'], reqLvl: 21, group: 23 },
    'Wizardry': { stats: { energy: { min: 16, max: 20 } }, itemTypes: ['Amulet', 'Orb', 'Circlet', 'Wand', 'Staff', 'Helm', 'Chest'], reqLvl: 23, group: 23 },
    'Wizardry2': { stats: { energy: { min: 16, max: 20 } }, itemTypes: ['Shield'], reqLvl: 23, group: 23 },
    'Wizardry3': { stats: { energy: { min: 16, max: 20 } }, itemTypes: ['Ring'], reqLvl: 33, group: 23 },
    'Enlightenment': { stats: { energy: { min: 21, max: 30 } }, itemTypes: ['Amulet', 'Orb', 'Circlet', 'Wand', 'Staff', 'Helm', 'Chest'], reqLvl: 33, group: 23 },
    'Enlightenment2': { stats: { energy: { min: 21, max: 30 } }, itemTypes: ['Shield'], reqLvl: 33, group: 23 },

    // === GROUP 24: Knockback ===
    'Bear': { stats: { knockback: { min: 1, max: 1 } }, itemTypes: ['Melee Weapon'], reqLvl: 6, group: 24 },
    'Bear2': { stats: { knockback: { min: 1, max: 1 } }, itemTypes: ['Quiver'], reqLvl: 24, group: 24 },
    ...
    'Light2': { stats: { lightrad: { min: 1, max: 1 }, toatt: { min: 15, max: 30 } }, itemTypes: ['Armor', 'Rod', 'Ring', 'Amulet', 'Quiver'], reqLvl: 4, group: 25 },
    ...
    'Radiance2': { stats: { lightrad: { min: 3, max: 3 }, toatt: { min: 30, max: 60 } }, itemTypes: ['Ring', 'Amulet'], reqLvl: 11, group: 25 },
    ...
    'Sunset2': { stats: { lightrad: { min: 5, max: 8 }, toatt: { min: 10, max: 10 } }, itemTypes: ['Rod', 'Missile Weapon', 'Gloves', 'Ring', 'Amulet', 'Helm', 'Chest'], reqLvl: 26, group: 25 },
    'Jackal': { stats: { tolife: { min: 1, max: 5 } }, itemTypes: ['Chest', 'Belt', 'Amulet', 'Barbarian Helm', 'Circlet'], reqLvl: 1, group: 26 },
    'Jackal2': { stats: { tolife: { min: 1, max: 5 } }, itemTypes: ['Shield', 'Druid Helm'], reqLvl: 3, group: 26 },
    'Jackal3': { stats: { tolife: { min: 1, max: 5 } }, itemTypes: ['Mace', 'Ring', 'Helm'], reqLvl: 6, group: 26 },

    // === GROUP 26: Life ===
    'Fox': { stats: { tolife: { min: 6, max: 10 } }, itemTypes: ['Chest', 'Belt', 'Amulet', 'Barbarian Helm', 'Circlet', 'Quiver'], reqLvl: 5, group: 26 },
    'Fox2': { stats: { tolife: { min: 6, max: 10 } }, itemTypes: ['Shield', 'Druid Helm'], reqLvl: 8, group: 26 },
    'Fox3': { stats: { tolife: { min: 6, max: 10 } }, itemTypes: ['Mace', 'Helm'], reqLvl: 13, group: 26 },
    'Fox4': { stats: { tolife: { min: 6, max: 10 } }, itemTypes: ['Ring'], reqLvl: 13, group: 26 },
    'Wolf': { stats: { tolife: { min: 11, max: 20 } }, itemTypes: ['Chest', 'Barbarian Helm', 'Circlet', 'Quiver'], reqLvl: 11, group: 26 },
    'Wolf2': { stats: { tolife: { min: 11, max: 20 } }, itemTypes: ['Amulet', 'Belt'], reqLvl: 11, group: 26 },
    'Wolf3': { stats: { tolife: { min: 11, max: 20 } }, itemTypes: ['Shield', 'Druid Helm'], reqLvl: 20, group: 26 },
    'Wolf4': { stats: { tolife: { min: 11, max: 20 } }, itemTypes: ['Mace', 'Helm'], reqLvl: 26, group: 26 },
    'Wolf5': { stats: { tolife: { min: 11, max: 20 } }, itemTypes: ['Ring'], reqLvl: 26, group: 26 },
    'Tiger': { stats: { tolife: { min: 21, max: 30 } }, itemTypes: ['Chest', 'Belt', 'Amulet', 'Barbarian Helm', 'Circlet', 'Quiver'], reqLvl: 15, group: 26 },
    'Tiger2': { stats: { tolife: { min: 21, max: 30 } }, itemTypes: ['Shield', 'Druid Helm'], reqLvl: 35, group: 26 },
    'Tiger3': { stats: { tolife: { min: 21, max: 30 } }, itemTypes: ['Mace', 'Ring', 'Helm'], reqLvl: 43, group: 26 },
    'Mammoth': { stats: { tolife: { min: 31, max: 40 } }, itemTypes: ['Chest', 'Belt', 'Amulet', 'Barbarian Helm', 'Circlet', 'Quiver'], reqLvl: 18, group: 26 },
    'Mammoth2': { stats: { tolife: { min: 31, max: 40 } }, itemTypes: ['Shield', 'Druid Helm'], reqLvl: 51, group: 26 },
    'Mammoth3': { stats: { tolife: { min: 31, max: 40 } }, itemTypes: ['Mace', 'Ring', 'Helm'], reqLvl: 60, group: 26 },
    'Colossus': { stats: { tolife: { min: 41, max: 60 } }, itemTypes: ['Chest', 'Belt', 'Amulet', 'Barbarian Helm', 'Circlet'], reqLvl: 22, group: 26 },
    'Colossus2': { stats: { tolife: { min: 41, max: 60 } }, itemTypes: ['Shield', 'Druid Helm'], reqLvl: 67, group: 26 },
    'Squid': { stats: { tolife: { min: 61, max: 80 } }, itemTypes: ['Chest', 'Belt', 'Barbarian Helm', 'Circlet', 'Shield'], reqLvl: 30, group: 26 },
    'Squid2': { stats: { tolife: { min: 61, max: 80 } }, itemTypes: ['Amulet'], reqLvl: 30, group: 26 },
    'Whale': { stats: { tolife: { min: 81, max: 100 } }, itemTypes: ['Chest', 'Belt', 'Barbarian Helm', 'Circlet', 'Shield'], reqLvl: 37, group: 26 },
    'Whale2': { stats: { tolife: { min: 81, max: 100 } }, itemTypes: ['Amulet'], reqLvl: 37, group: 26 },

    // === GROUP 27: Life Leech ===
    'Leech': { stats: { lifesteal: { min: 2, max: 3 } }, itemTypes: ['Amulet'], reqLvl: 20, group: 27 },
    'Leech2': { stats: { lifesteal: { min: 3, max: 3 } }, itemTypes: ['Gloves'], reqLvl: 26, group: 27 },
    'Leech3': { stats: { lifesteal: { min: 3, max: 4 } }, itemTypes: ['Ring', 'Circlet', 'Helm'], reqLvl: 10, group: 27 },
    'Leech4': { stats: { lifesteal: { min: 4, max: 5 } }, itemTypes: ['Melee Weapon', 'Missile Weapon', 'Quiver'], reqLvl: 4, group: 27 },
    'Locust': { stats: { lifesteal: { min: 4, max: 5 } }, itemTypes: ['Amulet'], reqLvl: 45, group: 27 },
    'Locust2': { stats: { lifesteal: { min: 5, max: 6 } }, itemTypes: ['Ring', 'Circlet', 'Helm'], reqLvl: 35, group: 27 },
    'Locust3': { stats: { lifesteal: { min: 6, max: 7 } }, itemTypes: ['Melee Weapon', 'Quiver'], reqLvl: 15, group: 27 },
    'Lamprey': { stats: { lifesteal: { min: 6, max: 6 } }, itemTypes: ['Amulet'], reqLvl: 63, group: 27 },
    'Lamprey2': { stats: { lifesteal: { min: 6, max: 9 } }, itemTypes: ['Quiver'], reqLvl: 43, group: 27 },
    'Lamprey3': { stats: { lifesteal: { min: 7, max: 8 } }, itemTypes: ['Ring', 'Circlet'], reqLvl: 65, group: 27 },
    'Lamprey4': { stats: { lifesteal: { min: 8, max: 9 } }, itemTypes: ['Melee Weapon'], reqLvl: 43, group: 27 },

    // === GROUP 28: Mana Leech ===
    'Bat': { stats: { manasteal: { min: 2, max: 3 } }, itemTypes: ['Ring'], reqLvl: 21, group: 28 },
    'Bat2': { stats: { manasteal: { min: 3, max: 3 } }, itemTypes: ['Gloves'], reqLvl: 27, group: 28 },
    'Bat3': { stats: { manasteal: { min: 3, max: 4 } }, itemTypes: ['Amulet', 'Circlet', 'Helm'], reqLvl: 11, group: 28 },
    'Bat4': { stats: { manasteal: { min: 4, max: 5 } }, itemTypes: ['Melee Weapon', 'Missile Weapon', 'Quiver'], reqLvl: 4, group: 28 },
    'Wraith': { stats: { manasteal: { min: 4, max: 5 } }, itemTypes: ['Ring'], reqLvl: 46, group: 28 },
    'Wraith2': { stats: { manasteal: { min: 5, max: 6 } }, itemTypes: ['Amulet', 'Circlet', 'Helm'], reqLvl: 40, group: 28 },
    'Wraith3': { stats: { manasteal: { min: 6, max: 7 } }, itemTypes: ['Melee Weapon', 'Quiver'], reqLvl: 16, group: 28 },
    'Vampire': { stats: { manasteal: { min: 6, max: 6 } }, itemTypes: ['Ring'], reqLvl: 64, group: 28 },
    'Vampire2': { stats: { manasteal: { min: 6, max: 9 } }, itemTypes: ['Quiver'], reqLvl: 48, group: 28 },
    'Vampire3': { stats: { manasteal: { min: 7, max: 8 } }, itemTypes: ['Amulet', 'Circlet'], reqLvl: 66, group: 28 },
    ...
    'Strength2': { stats: { str: { min: 1, max: 1 } }, itemTypes: ['Ring'], reqLvl: 1, group: 31 },
    'Strength3': { stats: { str: { min: 1, max: 2 } }, itemTypes: ['Amulet', 'Belt', 'Club', 'Hammer', 'Circlet', 'Helm'], reqLvl: 1, group: 31 },
    'Strength4': { stats: { str: { min: 1, max: 2 } }, itemTypes: ['Ring', 'Scepter', 'Mace'], reqLvl: 3, group: 31 },
    'Strength5': { stats: { str: { min: 1, max: 2 } }, itemTypes: ['WeaponP', 'Gloves', 'Shield', 'Chest'], reqLvl: 8, group: 31 },
    'Might': { stats: { str: { min: 3, max: 5 } }, itemTypes: ['Belt', 'Club', 'Hammer', 'Circlet', 'Quiver', 'Helm'], reqLvl: 8, group: 31 },
    'Might2': { stats: { str: { min: 3, max: 5 } }, itemTypes: ['Amulet', 'Ring', 'Gloves'], reqLvl: 8, group: 31 },
    'Might3': { stats: { str: { min: 3, max: 5 } }, itemTypes: ['Scepter', 'Mace', 'Chest'], reqLvl: 15, group: 31 },
    'Might4': { stats: { str: { min: 3, max: 5 } }, itemTypes: ['WeaponP', 'Shield', 'Chest'], reqLvl: 25, group: 31 },
    'Ox': { stats: { str: { min: 6, max: 9 } }, itemTypes: ['Amulet', 'Belt', 'Club', 'Hammer', 'Circlet', 'Quiver', 'Helm'], reqLvl: 19, group: 31 },
    'Ox2': { stats: { str: { min: 6, max: 9 } }, itemTypes: ['Ring', 'Scepter', 'Mace', 'Chest'], reqLvl: 30, group: 31 },
    'Ox3': { stats: { str: { min: 6, max: 9 } }, itemTypes: ['WeaponP', 'Gloves', 'Shield', 'Chest'], reqLvl: 37, group: 31 },
    'Giant': { stats: { str: { min: 10, max: 15 } }, itemTypes: ['Amulet', 'Belt', 'Club', 'Hammer', 'Circlet', 'Quiver', 'Helm'], reqLvl: 34, group: 31 },
    'Giant2': { stats: { str: { min: 10, max: 15 } }, itemTypes: ['Ring', 'Scepter', 'Mace', 'Chest', 'Shield'], reqLvl: 47, group: 31 },
    'Giant3': { stats: { str: { min: 10, max: 15 } }, itemTypes: ['WeaponP', 'Gloves'], reqLvl: 51, group: 31 },
    'Titan': { stats: { str: { min: 16, max: 20 } }, itemTypes: ['Amulet', 'Belt', 'Club', 'Hammer', 'Circlet', 'Helm'], reqLvl: 50, group: 31 },
    'Titan2': { stats: { str: { min: 16, max: 20 } }, itemTypes: ['Ring', 'Scepter', 'Mace', 'Chest', 'Shield'], reqLvl: 66, group: 31 },
    'Atlas': { stats: { str: { min: 21, max: 30 } }, itemTypes: ['Amulet', 'Belt', 'Club', 'Hammer', 'Circlet', 'Helmet', 'Shield'], reqLvl: 63, group: 31 },
    'Atlas2': { stats: { str: { min: 21, max: 30 } }, itemTypes: ['Chest'], reqLvl: 63, group: 31 },

    // === GROUP 35: Run/Walk ===
    'Pacing': { stats: { frw: { min: 10, max: 10 } }, itemTypes: ['Boots', 'Circlet'], reqLvl: 8, group: 35 },
    'Pacing2': { stats: { frw: { min: 10, max: 10 } }, itemTypes: ['Amazon Weapon', 'Quiver'], reqLvl: 8, group: 35 },
    'Haste': { stats: { frw: { min: 20, max: 20 } }, itemTypes: ['Boots', 'Circlet'], reqLvl: 16, group: 35 },
    'Haste2': { stats: { frw: { min: 20, max: 20 } }, itemTypes: ['Amazon Weapon', 'Quiver'], reqLvl: 16, group: 35 },
    ...
    'Centaur2': { stats: { scalinglife: { min: 0, max: 74 } }, itemTypes: ['Amulet'], reqLvl: 1, group: 41 },
    'Mnemonic2': { stats: { scalingmana: { min: 0, max: 74 } }, itemTypes: ['Circlet', 'Amulet', 'Druid Helm'], reqLvl: 1, group: 41 },
    ...
    'Defending2': { stats: { pdmgred: { min: 5, max: 10 } }, itemTypes: ['Belt'], reqLvl: 40, group: 251 },
