class SkillHandler {
          ...
          javelinAndSpear: {
            ...
            poisonJavelin: {
              ...
              levelData: {
                poisonDamage: {
                  min: [
                    2, 4, 6, 9, 11, 13, 16, 18, 25, 32, 39, 46, 53, 60, 67, 74,
                    88, 102, 116, 131, 145, 159, 187, 215, 143, 271, 299, 327,
                    384, 440, 496, 552, 609, 665, 721, 777, 834, 890, 946, 1002,
                    1059, 1115, 1171, 1227, 1284, 1340, 1396, 1452, 1509, 1565,
                    1621, 1677, 1734, 1790, 1846, 1902, 1959, 2015, 2071, 2127,
                  ],
                  max: [
                    5, 7, 10, 12, 15, 17, 19, 22, 29, 37, 44, 51, 58, 66, 73, 80,
                    95, 110, 124, 139, 154, 168, 198, 227, 256, 286, 315, 344,
                    403, 461, 520, 579, 637, 696, 754, 813, 871, 930, 989, 1047,
            ...
            lightningBolt: {
              ...
              levelData: {
                lightningDamage: {
                  min: 1,
                  max: [
                    40, 52, 64, 76, 88, 100, 112, 124, 150, 176, 202, 228, 254,
                    280, 306, 332, 386, 440, 494, 548, 602, 656, 738, 820, 902,
                    984, 1066, 1148, 1258, 1368, 1478, 1588, 1698, 1808, 1918,
                    2028, 2138, 2248, 2358, 2468, 2578, 2688, 2798, 2908, 3018,
                    3128, 3238, 3348, 3458, 3568, 3678, 3788, 3898, 4008, 4118,
                    4228, 4338, 4448, 4558,
                  ],
                },
                manaCost: {
            ...
            chargedStrike: {
              name: "Charged Strike",
              description: "Charged hdhjavelin attack",
              maxLevel: 99,
              levelData: {
                    attackRating: {
                        base: 30,
    ...
    getSkillInfo(className, treeName, skillName, level) {
      ...
      const calculateValue = (data) => {
        if (
          !data ||
          typeof data.base === "undefined" ||
          typeof data.perLevel === "undefined"
        ) {
          return 0;
        }
      ...
      return {
        ...
        damage: skill.levelData.damage
          ? calculateValue(skill.levelData.damage)
          : 0,
